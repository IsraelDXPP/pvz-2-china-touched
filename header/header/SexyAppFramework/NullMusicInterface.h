#ifndef __NULLMUSICINTERFACE_H__
#define __NULLMUSICINTERFACE_H__
...
namespace Sexy
{
	...
	class NullMusicInterface : public MusicInterface
	{
	public:		
		
	public:
		NullMusicInterface() {}
		virtual ~NullMusicInterface() {}
		
		virtual bool			LoadMusic(int theSongId, const std::string& theFileName) { return true; }
		...
		virtual bool			IsPlaying(int theSongId) { return true; }
