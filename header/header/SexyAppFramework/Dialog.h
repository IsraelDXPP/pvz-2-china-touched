...
public:
    ...
    PrimeTypeface*          mHeaderPrimeFont;
	PrimeTypeface*          mLinesPrimeFont;
#endif
    //PVZ2_CHINESE_END
...
public:
	...
	Dialog(int theId, bool isModal, const SexyString& theDialogHeader, const SexyString& theDialogLines, const SexyString& theDialogFooter, int theButtonMode); //UNICODE
 
	void SetButtonComponentImage(ImagePtr i_image);
...
#ifdef WIDGETS_USE_PRIMETEXT
    virtual void			SetButtonFont(PrimeTypeface* theFont);
	virtual void			SetHeaderFont(PrimeTypeface* theFont);
	virtual void			SetLinesFont(PrimeTypeface* theFont);
#endif
