...
namespace EA
{
    namespace Allocator
    {
        ...
        public:
            ...
            typedef void* (*CoreAddFunction)(void* userData, size_t minSize, size_t* reservedSize, CoreFreeFunction* freeFn, void** freeFnContext, CoreExtendFunction* extendFn, void** extendFnContext);
            void SetAddCoreFunction(CoreAddFunction fn, void* userData);
            ...
            /// This function calls the CoreAddFunction if the user specified one via SetAddCoreFunction.
...
namespace EA
{
    namespace Allocator
    {
        ...
        */
        ...
        {
            #if PPM_FASTBINS_ENABLED
                return (unsigned int)(mnMaxFastBinChunkSize & ~kFlagFastBinChunksExist);
            #else
                return 0;
            #endif
        }
