...
#elif defined(EA_PROCESSOR_MIPS) || defined(EA_PROCESSOR_R5900) || defined(EA_PROCESSOR_R3000) || defined(EA_PROCESSOR_R4000)
    #include <eathread/mips/eathread_atomic_mips.h>
#elif defined(EA_PROCESSOR_POWERPC) || defined(EA_PLATFORM_XENON) || defined(EA_PLATFORM_PS3) || defined(EA_PLATFORM_PS3_SPU)
...
namespace EA
{
    ...
    // If we need to add an exception here, we can add an appropriate ifdef.
        ...
        // CTR (a.k.a. Nintendo 3DS) appears to support atomics via the compiler or their Interlocked APIs, but this platform is dead to us and not worth writing the support for this.
    #else
