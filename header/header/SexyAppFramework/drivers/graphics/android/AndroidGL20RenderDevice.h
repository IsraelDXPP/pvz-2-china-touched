...
namespace Sexy 
{
	...
	void			SetGL20BackbufferImages( class AndroidAppDriver* theAppDriver, class RenderDevice3D* theDevice, class Image* theImage, class Image* theSwappableImage);
...
#endif
	DeviceImage*	GetGL20ImageFromResStream(RenderDevice3D* theDevice
    ...
    DeviceImage*	GetGL20OptimizedImage(RenderDevice3D* theDevice, ImageLib::Image *aSrcImage, bool commitBits, bool allowTriReps, bool shouldDeleteSrcImage);
