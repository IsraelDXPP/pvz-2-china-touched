#pragma once
#ifndef XBOX360APPDRIVER_H_INCLUDED
#define XBOX360APPDRIVER_H_INCLUDED

#include "IAppDriver.h"
#include "drivers/misc/xbox360/Xbox360Errors.h"
...
namespace Sexy
{
	...
	class Xbox360GraphicsDriver;

	class Xbox360AppDriver  : public IAppDriver, public Sexy::DialogListener
	{
	public:
		Xbox360AppDriver(SexyAppBase*);
		virtual ~Xbox360AppDriver();
	...
	protected:
		...
		static DWORD LoadingThreadProcStub(void *param);
	public:
		SexyAppBase*	mApp;
		Xbox360GraphicsDriver* mXbox360GraphicsDriver;
