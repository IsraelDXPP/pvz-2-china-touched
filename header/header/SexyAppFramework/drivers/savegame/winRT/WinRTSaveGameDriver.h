#ifndef __WINRT_SAVEGAMEDRIVER__
#define __WINRT_SAVEGAMEDRIVER__
...
namespace Sexy
{
	class WinRTSaveGameDriver : public ISaveGameDriver
	{
	public:
		WinRTSaveGameDriver();
	...
	class WinRTSaveGameContext : public ISaveGameContext
	{
	public:
		WinRTSaveGameContext( UserProfile *player, const std::string &filename );
	...
	private:
		friend class WinRTSaveGameDriver;
