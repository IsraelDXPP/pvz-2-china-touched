...
#ifndef __ZOMBIEANIMRIG_STEAMBASIC_H__
#define __ZOMBIEANIMRIG_STEAMBASIC_H__

#include "Precompile.h"
#include "ZombieAnimRig.h"
#include "ZombieAnimRig_Basic.h"

class ZombieAnimRig_SteamBasic : public ZombieAnimRig_Basic
{
public:
	RT_CLASS_DEFINE(ZombieAnimRig_SteamBasic, ZombieAnimRig_Basic, RtClass) {}
