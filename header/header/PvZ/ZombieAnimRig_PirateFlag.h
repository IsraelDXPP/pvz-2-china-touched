...
#ifndef PlantsVersusZombies2_ZombieAnimRig_PirateFlag_h
#define PlantsVersusZombies2_ZombieAnimRig_PirateFlag_h

#include "ZombieAnimRig_Basic.h"

class ZombieAnimRig_PirateFlag : public ZombieAnimRig_Basic
{
public:
	RT_CLASS_DEFINE(ZombieAnimRig_PirateFlag, ZombieAnimRig_Basic, RtClass) {}
