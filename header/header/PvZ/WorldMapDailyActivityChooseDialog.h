/*
 * WorldMapDailyActivityChooseDialog.h
 *
 *  Created on: 2021-3-22
 *      Author: zhousen
 */

#ifndef WORLDMAPDAILYACTIVITYCHOOSEDIALOG_H_
#define WORLDMAPDAILYACTIVITYCHOOSEDIALOG_H_


class WorldMapDailyActivityChooseDialog : public Widget, Sexy::ButtonListener, public InterfaceChooseDialog
{
public:
	WorldMapDailyActivityChooseDialog(int activityIndex);
    ~WorldMapDailyActivityChooseDialog();
...
#endif /* WORLDMAPDAILYACTIVITYCHOOSEDIALOG_H_ */
