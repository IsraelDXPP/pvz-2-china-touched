...
///////////////////////////////////////////////////////////////////////////////
    ...
    #define EATEXT_VERSION   "1.09.06"
    #define EATEXT_VERSION_N  10906
#endif
...
// and in general should be avoided when possible. 
    ...
    namespace EA
    {
        namespace Text
        {
            const char16_t* Text32PtrToText16Ptr(const wchar_t* pText32);
        }
    }
#endif

// Important Note: To sustain cross platform and older code compatibility this must follow eabase.h char16_t typedef.
    ...
    #else
        #if(EATEXT_CHAR_TYPE_SIZE == 2) // If EA_CHAR16 is not define and the size of EATEXT_CHAR is 2 byte, we are on a 32 bits wchar_t platform and we must convert to 16 bits.
            #define EATEXT_CHAR(x) EA::Text::Text32PtrToText16Ptr( L##x )
        #elif (EATEXT_CHAR_TYPE_SIZE == 4)
...
//
    ...
    #define EA_TEXT_CACHE_TEXTURE_SLOT_COUNT 1
#endif
...
// EAText currently uses Font Fusion to rasterize glyphs from .ttf files.
// However, occasionally the glyphs Font Fusion generates have tiny artifacts
