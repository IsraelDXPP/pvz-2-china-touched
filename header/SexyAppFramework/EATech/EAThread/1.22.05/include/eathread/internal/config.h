...
//
    ...
    #define EATHREAD_VERSION   "1.22.05"
    #define EATHREAD_VERSION_N  12205
...
//
        ...
        #define EATHREAD_GETCALLSTACK_SUPPORTED 1
    #elif defined(EA_PLATFORM_PSP2)                 // Sony PSVita
        #define EATHREAD_GETCALLSTACK_SUPPORTED 1
    #elif defined(__QNX__) && defined(EA_DEBUG)
        #define EATHREAD_GETCALLSTACK_SUPPORTED 1
...
//
    ...
    #if defined(EA_PLATFORM_MICROSOFT) && defined(EA_PLATFORM_CONSOLE) && !defined(EA_PLATFORM_XENON)
        #define EATHREAD_MIN_ABSOLUTE_TIME  4000
    #else
...
//
        ...
        // PS3 doesn't not provided a mechanism to set thread affinities.
    ...
    #elif defined(EA_PLATFORM_KETTLE)
        #define EATHREAD_THREAD_AFFINITY_MASK_SUPPORTED 1
    #elif defined(EA_USE_CPP11_CONCURRENCY)
