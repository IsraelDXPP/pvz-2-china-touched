...
namespace EA
{
    namespace Thread
    {
        ...
        #elif defined(__MWERKS__) && defined(EA_PROCESSOR_POWERPC) 
        ...
        #elif defined(__GNUC__) || defined(EA_COMPILER_CLANG) // This covers EA_PLATFORM_PS3, EA_PLATFORM_UNIX, EA_PLATFORM_OSX 
        ...
        #elif defined(__GNUC__) // This covers EA_PLATFORM_PS3, EA_PLATFORM_UNIX, EA_PLATFORM_OSX
