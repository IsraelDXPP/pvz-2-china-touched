...
namespace EA
{
    ...
    namespace Thread
    {
        ...
        typedef int64_t ThreadAffinityMask;
        const ThreadAffinityMask kThreadAffinityMaskAny = -1;
        ...
        /// available threads.
        ///
        /// Note:  On PS3, due to the usage of sys_timer_thread_yield for ThreadSleep(0), a 
        /// ThreadSleep(0) will yield to higher priority threads first as outlined by Sony's docs. 
