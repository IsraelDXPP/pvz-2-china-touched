...
//PVZ2_CHINESE_BEGIN
//#ifdef WIDGETS_USE_PRIMETEXT
//    typedef     PrimeTypeface      WidgetFont;
//#else
//    typedef     Font               WidgetFont;
//#endif
//PVZ2_CHINESE_END
...
public:			
	...
	//JVW TODO: fold tabprev and next into gamelinks
	Widget*					mTabPrev;
	Widget*					mTabNext;	
...
public:
	...
	virtual void            Translate(int theX, int theY);
	...
	virtual void			UpdateF(float theFrac) override;
	virtual void			GotFocus();
	virtual void			LostFocus();	
	virtual void			KeyChar(SexyChar theChar);
	virtual void			KeyDown(KeyCode theKey);
	virtual void			KeyUp(KeyCode theKey);
	//virtual void			KeyMessageRaw(void* hwnd, unsigned int message, unsigned __int64 wparam, __int64 lparam);
    ...
    virtual bool			ShouldReceiveAllOverTouchEvents() { return mReceiveAllOverTouchEvents; }
...
//PVZ2_CHINESE_BEGIN
    ...
    virtual Rect			WriteCenteredLine(Graphics* g, Color color, int anOffset, const SexyString& theLine);
    ...
    virtual int				WriteWordWrapped(Graphics* g, Color color, const Rect& theRect, const SexyString& theLine, int theLineSpacing, int theJustification);
...
protected:
    bool					mReceiveAllOverTouchEvents;
};
