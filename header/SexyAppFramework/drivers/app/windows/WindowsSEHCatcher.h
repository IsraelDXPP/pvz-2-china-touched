#ifndef __WINDOWSSEHCATHER_H__
#define __WINDOWSSEHCATHER_H__
#include "Common.h"

#ifdef SUPPORT_SEH_CATCHER
...
typedef USHORT (__stdcall *RTLCAPTURESTACKBACKTRACE)(ULONG, ULONG, PVOID*, PULONG);

class WindowsSEHCatcher 
{
public:	
	...
	static SYMGETLINEFROMADDRPROC mSymGetLineFromAddr;
