#pragma once
#ifndef AIRPLAYAPPDRIVER_H_INCLUDED
#define AIRPLAYAPPDRIVER_H_INCLUDED
...
namespace Sexy
{
	...
	class AirplayAppDriver  : public IAppDriver
	{
	public:
		AirplayAppDriver(SexyAppBase*);
		virtual ~AirplayAppDriver();
  ...
  private:
    ...
    static void MultiTouchButtonCB(s3ePointerTouchEvent* event, void* pUserData);
    static void MultiTouchMotionCB(s3ePointerTouchMotionEvent* event, void* pUserData);
    static void SingleTouchButtonCB(s3ePointerEvent* event, void* pUserData);
    static void SingleTouchMotionCB(s3ePointerMotionEvent* event, void* pUserData);

    static void SetTouch(Touch* pcTouch, s3ePointerEvent* eventSingle, s3ePointerTouchEvent* eventMulti);
    static void SetTouch(Touch* pcTouch, s3ePointerMotionEvent* eventSingle, s3ePointerTouchMotionEvent* eventMulti);

    static void KeyboardEventCB(void* pEvent, void* pUserData);

    void FakeLoadingThreadProc();

  public:
		SexyAppBase*	mApp;
		AirplayGraphicsDriver* mAirplayGraphicsDriver;
