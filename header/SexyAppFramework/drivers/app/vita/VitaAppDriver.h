#pragma once
#ifndef VITAAPPDRIVER_H_INCLUDED
#define VITAAPPDRIVER_H_INCLUDED

#include "IAppDriver.h"
#include "drivers/app/vita/VitaTouchEvent.h"

namespace Sexy
{
	class VitaGraphicsDriver;

	class VitaAppDriver  : public IAppDriver
	{
	public:
		VitaAppDriver(SexyAppBase*);
		virtual ~VitaAppDriver();
	...
	public:
		...
		void ConvertToTouchObject(TouchEventElem* vitaTouch, Touch* popTouch);
	...
	private:
		...
		TouchEventInfo mTouchEventInfo;
		bool mHasTouchesToProcess;
		SceTouchData mData;
