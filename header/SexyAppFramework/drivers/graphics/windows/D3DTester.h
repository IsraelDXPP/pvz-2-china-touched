...
protected:
	...
	void Cleanup();
	bool DoTest(WindowsGraphicsDriver* theDriver);
...
public:
	...
	static int StaticGetVideoMemoryMB(); // get video memory amount w/o having to create an actual d3dtester object
	...
	void TestD3D(HWND theHWND, LPDIRECTDRAW7 theDDraw, WindowsGraphicsDriver* theDriver);
};
