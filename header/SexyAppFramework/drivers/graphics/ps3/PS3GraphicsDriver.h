#ifndef PS3GRAPHICSDRIVER_H_INCLUDED
#define PS3GRAPHICSDRIVER_H_INCLUDED
...
//#include "PS3OptimizedPngLoader.h"
#include "PS3RenderDevice.h"
...
namespace Sexy
{
	...
	class PS3GraphicsDriver : public IGraphicsDriver, protected NativeDisplay
	{
	public:
		PS3RenderDevice* mRenderDevice;
		
		PS3GraphicsDriver(PS3AppDriver*,SexyAppBase*);
		virtual ~PS3GraphicsDriver();
...
//		PS3OptimizedPngLoader *mPngLoader;
		DeviceImage* GetOptimizedPS3Image(const std::string& theFileName, bool commitBits, bool allowTriReps);
	...
	protected:
		...
		PS3RenderDevice::TextureData* mDoubleBufferTextureData;
