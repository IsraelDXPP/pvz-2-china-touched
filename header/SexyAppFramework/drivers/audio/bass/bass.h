...
#ifdef BASS_USE_NAMESPACE
namespace BASS_NAMESPACE {
#endif

BASSEXTERN BOOL BASSDEF(BASS_SetConfig)(DWORD option, DWORD value);
BASSEXTERN DWORD BASSDEF(BASS_GetConfig)(DWORD option);
BASSEXTERN BOOL BASSDEF(BASS_SetConfigPtr)(DWORD option, void *value);
BASSEXTERN void *BASSDEF(BASS_GetConfigPtr)(DWORD option);
BASSEXTERN DWORD BASSDEF(BASS_GetVersion)();
BASSEXTERN int BASSDEF(BASS_ErrorGetCode)();
BASSEXTERN BOOL BASSDEF(BASS_GetDeviceInfo)(DWORD device, BASS_DEVICEINFO *info);
#if defined(_WIN32)
BASSEXTERN BOOL BASSDEF(BASS_Init)(int device, DWORD freq, DWORD flags, HWND win, const GUID *dsguid);
#else
BASSEXTERN BOOL BASSDEF(BASS_Init)(int device, DWORD freq, DWORD flags, void *win, void *dsguid);
#endif
BASSEXTERN BOOL BASSDEF(BASS_SetDevice)(DWORD device);
BASSEXTERN DWORD BASSDEF(BASS_GetDevice)();
BASSEXTERN BOOL BASSDEF(BASS_Free)();
#ifdef _WIN32
BASSEXTERN void *BASSDEF(BASS_GetDSoundObject)(DWORD object);
#endif
BASSEXTERN BOOL BASSDEF(BASS_GetInfo)(BASS_INFO *info);
BASSEXTERN BOOL BASSDEF(BASS_Update)(DWORD length);
BASSEXTERN float BASSDEF(BASS_GetCPU)();
BASSEXTERN BOOL BASSDEF(BASS_Start)();
BASSEXTERN BOOL BASSDEF(BASS_Stop)();
BASSEXTERN BOOL BASSDEF(BASS_Pause)();
BASSEXTERN BOOL BASSDEF(BASS_SetVolume)(float volume);
BASSEXTERN float BASSDEF(BASS_GetVolume)();

BASSEXTERN HPLUGIN BASSDEF(BASS_PluginLoad)(const char *file, DWORD flags);
BASSEXTERN BOOL BASSDEF(BASS_PluginFree)(HPLUGIN handle);
BASSEXTERN const BASS_PLUGININFO *BASSDEF(BASS_PluginGetInfo)(HPLUGIN handle);

BASSEXTERN BOOL BASSDEF(BASS_Set3DFactors)(float distf, float rollf, float doppf);
BASSEXTERN BOOL BASSDEF(BASS_Get3DFactors)(float *distf, float *rollf, float *doppf);
BASSEXTERN BOOL BASSDEF(BASS_Set3DPosition)(const BASS_3DVECTOR *pos, const BASS_3DVECTOR *vel, const BASS_3DVECTOR *front, const BASS_3DVECTOR *top);
BASSEXTERN BOOL BASSDEF(BASS_Get3DPosition)(BASS_3DVECTOR *pos, BASS_3DVECTOR *vel, BASS_3DVECTOR *front, BASS_3DVECTOR *top);
BASSEXTERN void BASSDEF(BASS_Apply3D)();
#ifdef _WIN32
BASSEXTERN BOOL BASSDEF(BASS_SetEAXParameters)(int env, float vol, float decay, float damp);
BASSEXTERN BOOL BASSDEF(BASS_GetEAXParameters)(DWORD *env, float *vol, float *decay, float *damp);
#endif

BASSEXTERN HMUSIC BASSDEF(BASS_MusicLoad)(BOOL mem, const void *file, QWORD offset, DWORD length, DWORD flags, DWORD freq);
BASSEXTERN BOOL BASSDEF(BASS_MusicFree)(HMUSIC handle);

BASSEXTERN HSAMPLE BASSDEF(BASS_SampleLoad)(BOOL mem, const void *file, QWORD offset, DWORD length, DWORD max, DWORD flags);
BASSEXTERN HSAMPLE BASSDEF(BASS_SampleCreate)(DWORD length, DWORD freq, DWORD chans, DWORD max, DWORD flags);
BASSEXTERN BOOL BASSDEF(BASS_SampleFree)(HSAMPLE handle);
BASSEXTERN BOOL BASSDEF(BASS_SampleSetData)(HSAMPLE handle, const void *buffer);
BASSEXTERN BOOL BASSDEF(BASS_SampleGetData)(HSAMPLE handle, void *buffer);
BASSEXTERN BOOL BASSDEF(BASS_SampleGetInfo)(HSAMPLE handle, BASS_SAMPLE *info);
BASSEXTERN BOOL BASSDEF(BASS_SampleSetInfo)(HSAMPLE handle, const BASS_SAMPLE *info);
BASSEXTERN HCHANNEL BASSDEF(BASS_SampleGetChannel)(HSAMPLE handle, BOOL onlynew);
BASSEXTERN DWORD BASSDEF(BASS_SampleGetChannels)(HSAMPLE handle, HCHANNEL *channels);
BASSEXTERN BOOL BASSDEF(BASS_SampleStop)(HSAMPLE handle);

BASSEXTERN HSTREAM BASSDEF(BASS_StreamCreate)(DWORD freq, DWORD chans, DWORD flags, STREAMPROC *proc, void *user);
BASSEXTERN HSTREAM BASSDEF(BASS_StreamCreateFile)(BOOL mem, const void *file, QWORD offset, QWORD length, DWORD flags);
BASSEXTERN HSTREAM BASSDEF(BASS_StreamCreateURL)(const char *url, DWORD offset, DWORD flags, DOWNLOADPROC *proc, void *user);
BASSEXTERN HSTREAM BASSDEF(BASS_StreamCreateFileUser)(DWORD system, DWORD flags, const BASS_FILEPROCS *proc, void *user);
BASSEXTERN BOOL BASSDEF(BASS_StreamFree)(HSTREAM handle);
BASSEXTERN QWORD BASSDEF(BASS_StreamGetFilePosition)(HSTREAM handle, DWORD mode);
BASSEXTERN DWORD BASSDEF(BASS_StreamPutData)(HSTREAM handle, const void *buffer, DWORD length);
BASSEXTERN DWORD BASSDEF(BASS_StreamPutFileData)(HSTREAM handle, const void *buffer, DWORD length);

BASSEXTERN BOOL BASSDEF(BASS_RecordGetDeviceInfo)(DWORD device, BASS_DEVICEINFO *info);
BASSEXTERN BOOL BASSDEF(BASS_RecordInit)(int device);
BASSEXTERN BOOL BASSDEF(BASS_RecordSetDevice)(DWORD device);
BASSEXTERN DWORD BASSDEF(BASS_RecordGetDevice)();
BASSEXTERN BOOL BASSDEF(BASS_RecordFree)();
BASSEXTERN BOOL BASSDEF(BASS_RecordGetInfo)(BASS_RECORDINFO *info);
BASSEXTERN const char *BASSDEF(BASS_RecordGetInputName)(int input);
BASSEXTERN BOOL BASSDEF(BASS_RecordSetInput)(int input, DWORD flags, float volume);
BASSEXTERN DWORD BASSDEF(BASS_RecordGetInput)(int input, float *volume);
BASSEXTERN HRECORD BASSDEF(BASS_RecordStart)(DWORD freq, DWORD chans, DWORD flags, RECORDPROC *proc, void *user);

BASSEXTERN double BASSDEF(BASS_ChannelBytes2Seconds)(DWORD handle, QWORD pos);
BASSEXTERN QWORD BASSDEF(BASS_ChannelSeconds2Bytes)(DWORD handle, double pos);
BASSEXTERN DWORD BASSDEF(BASS_ChannelGetDevice)(DWORD handle);
BASSEXTERN BOOL BASSDEF(BASS_ChannelSetDevice)(DWORD handle, DWORD device);
BASSEXTERN DWORD BASSDEF(BASS_ChannelIsActive)(DWORD handle);
BASSEXTERN BOOL BASSDEF(BASS_ChannelGetInfo)(DWORD handle, BASS_CHANNELINFO *info);
BASSEXTERN const char *BASSDEF(BASS_ChannelGetTags)(DWORD handle, DWORD tags);
BASSEXTERN DWORD BASSDEF(BASS_ChannelFlags)(DWORD handle, DWORD flags, DWORD mask);
BASSEXTERN BOOL BASSDEF(BASS_ChannelUpdate)(DWORD handle, DWORD length);
BASSEXTERN BOOL BASSDEF(BASS_ChannelLock)(DWORD handle, BOOL lock);
BASSEXTERN BOOL BASSDEF(BASS_ChannelPlay)(DWORD handle, BOOL restart);
BASSEXTERN BOOL BASSDEF(BASS_ChannelStop)(DWORD handle);
BASSEXTERN BOOL BASSDEF(BASS_ChannelPause)(DWORD handle);
BASSEXTERN BOOL BASSDEF(BASS_ChannelSetAttribute)(DWORD handle, DWORD attrib, float value);
BASSEXTERN BOOL BASSDEF(BASS_ChannelGetAttribute)(DWORD handle, DWORD attrib, float *value);
BASSEXTERN BOOL BASSDEF(BASS_ChannelSlideAttribute)(DWORD handle, DWORD attrib, float value, DWORD time);
BASSEXTERN BOOL BASSDEF(BASS_ChannelIsSliding)(DWORD handle, DWORD attrib);
BASSEXTERN BOOL BASSDEF(BASS_ChannelSet3DAttributes)(DWORD handle, int mode, float min, float max, int iangle, int oangle, float outvol);
BASSEXTERN BOOL BASSDEF(BASS_ChannelGet3DAttributes)(DWORD handle, DWORD *mode, float *min, float *max, DWORD *iangle, DWORD *oangle, float *outvol);
BASSEXTERN BOOL BASSDEF(BASS_ChannelSet3DPosition)(DWORD handle, const BASS_3DVECTOR *pos, const BASS_3DVECTOR *orient, const BASS_3DVECTOR *vel);
BASSEXTERN BOOL BASSDEF(BASS_ChannelGet3DPosition)(DWORD handle, BASS_3DVECTOR *pos, BASS_3DVECTOR *orient, BASS_3DVECTOR *vel);
BASSEXTERN QWORD BASSDEF(BASS_ChannelGetLength)(DWORD handle, DWORD mode);
BASSEXTERN BOOL BASSDEF(BASS_ChannelSetPosition)(DWORD handle, QWORD pos, DWORD mode);
BASSEXTERN QWORD BASSDEF(BASS_ChannelGetPosition)(DWORD handle, DWORD mode);
BASSEXTERN DWORD BASSDEF(BASS_ChannelGetLevel)(DWORD handle);
BASSEXTERN DWORD BASSDEF(BASS_ChannelGetData)(DWORD handle, void *buffer, DWORD length);
BASSEXTERN HSYNC BASSDEF(BASS_ChannelSetSync)(DWORD handle, DWORD type, QWORD param, SYNCPROC *proc, void *user);
BASSEXTERN BOOL BASSDEF(BASS_ChannelRemoveSync)(DWORD handle, HSYNC sync);
BASSEXTERN HDSP BASSDEF(BASS_ChannelSetDSP)(DWORD handle, DSPPROC *proc, void *user, int priority);
BASSEXTERN BOOL BASSDEF(BASS_ChannelRemoveDSP)(DWORD handle, HDSP dsp);
BASSEXTERN BOOL BASSDEF(BASS_ChannelSetLink)(DWORD handle, DWORD chan);
BASSEXTERN BOOL BASSDEF(BASS_ChannelRemoveLink)(DWORD handle, DWORD chan);
BASSEXTERN HFX BASSDEF(BASS_ChannelSetFX)(DWORD handle, DWORD type, int priority);
BASSEXTERN BOOL BASSDEF(BASS_ChannelRemoveFX)(DWORD handle, HFX fx);

BASSEXTERN BOOL BASSDEF(BASS_FXSetParameters)(HFX handle, const void *params);
BASSEXTERN BOOL BASSDEF(BASS_FXGetParameters)(HFX handle, void *params);
BASSEXTERN BOOL BASSDEF(BASS_FXReset)(HFX handle);
