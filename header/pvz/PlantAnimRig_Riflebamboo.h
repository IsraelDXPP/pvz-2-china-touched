...
#ifndef PlantAnimRig_Riflebamboo_H_
#define PlantAnimRig_Riflebamboo_H_

#include "PlantAnimRig.h"

class PlantAnimRig_Riflebamboo : public PlantAnimRig
{
public:
	RT_CLASS_DEFINE(PlantAnimRig_Riflebamboo, PlantAnimRig, RtClass);
