...
#ifndef PlantsVersusZombies2_WorldMap_ShowFriendButton_h
#define PlantsVersusZombies2_WorldMap_ShowFriendButton_h
...
class WorldMap_ShowFriendButton : public UIWidget
{
	
public:
	RT_CLASS_DEFINE(WorldMap_ShowFriendButton, UIWidget, RtClass) {}

	WorldMap_ShowFriendButton();
	virtual ~WorldMap_ShowFriendButton();
